...
// joris vage foutmelding verholpen, erg vies
float Ki, Kd, Kp;
...
static void lcd_main_menu()
{
    ...
    MENU_ITEM(submenu, MSG_OFFSET, lcd_offset_menu);
...
static void lcd_offset_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_MAIN, lcd_main_menu);
    MENU_ITEM(gcode, MSG_OFFSET_10XMIN, PSTR("M192 X-10"));
    MENU_ITEM(gcode, MSG_OFFSET_10XPLUS, PSTR("M192 X+10"));
    MENU_ITEM(gcode, MSG_OFFSET_10YMIN, PSTR("M192 Y-10"));
    MENU_ITEM(gcode, MSG_OFFSET_10YPLUS, PSTR("M192 X+10"));
    MENU_ITEM(gcode, MSG_OFFSET_5XMIN, PSTR("M192 X-5"));
    MENU_ITEM(gcode, MSG_OFFSET_5XPLUS, PSTR("M192 X+5"));
    MENU_ITEM(gcode, MSG_OFFSET_5YMIN, PSTR("M192 Y-5"));
    MENU_ITEM(gcode, MSG_OFFSET_5YPLUS, PSTR("M192 X+5"));
    MENU_ITEM(gcode, MSG_OFFSET_1XMIN, PSTR("M192 X-1"));
    MENU_ITEM(gcode, MSG_OFFSET_1XPLUS, PSTR("M192 X+1"));
    MENU_ITEM(gcode, MSG_OFFSET_1YMIN, PSTR("M192 Y-1"));
    MENU_ITEM(gcode, MSG_OFFSET_1YPLUS, PSTR("M192 X+1"));
    END_MENU();
}
